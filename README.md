...
Web Console has been used behind [Apache](https://httpd.apache.org/) and [NGINX](https://www.nginx.com/) acting as reverse-proxy servers, although we recommend (and use on this site) [Caddy](https://caddyserver.com/).
...
Web Console lets you add formatted text to the output of your command-line script for display to the user, and can also display simple progress bars to the user. More details can be found on the [documentation page](docs/CUSTOMISATION).
